...
def letter_stat(our_str):
    """
    Функция для подсчета количества вхождений каждой буквы в строке
    :param our_str: строка, в которой будем считать буквы
    :return: возвращаем словарь, в котором ключ - буква, а значение - число вхождений этой буквы в строку
    """
    letters_dict = {char: our_str.count(char) for char in our_str}
    return letters_dict

...
class PublicTransport:
    """
    Класс описывает транспортные средства
    """
    ...
    def info(self):
        """
        Свойство для получения полной информации о транспортном средстве (по всем атрибутам)
        """
...
class Bus(PublicTransport):
    """
    Класс описывающий автобус, дочерний класс от PublicTransport
    """
    def __init__(self, brand, engine_power, year, color, max_speed, passangers, park, fare):
    ...
    def park(self):
        """
        Геттер для получения парка автобуса
        :return:
        """
        return self.__park
    ...
    def park(self, park):
        """
        Сеттер для установки парка автобуса, парк должен быть от 1000 до 9999:
...
class Tram(PublicTransport):
    """
    Класс описывает трамвай, наследуется от PublicTransport
    """
    ...
    def how_long(self):
        """
        Свойство для получения информации о времени в пути для трамвая
        """
        self.time = self.max_speed / (4 * self.path)
        return self.time
